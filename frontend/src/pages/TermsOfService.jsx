      ...
      <Box sx={{ pt: { xs: 14, md: 16 }, pb: { xs: 8, md: 10 }, px: { xs: 2, md: 4 }, backgroundColor: '#f6f8fb' }}>
        <Container maxWidth="md">
          ...
          <Typography variant="body1" paragraph>
            By accessing and using the services provided by Three13 I.T. Solutions, you agree to be bound by the following terms and conditions. All content, materials, and services on this platform are intended for educational and informational purposes only. Users are responsible for maintaining the confidentiality of their account credentials and for all activities that occur under their account. Unauthorized use, duplication, or distribution of course materials or proprietary content is strictly prohibited. Three13 I.T. Solutions reserves the right to update, modify, or terminate its services at any time without prior notice. By continuing to use our platform, you accept any changes to these terms. If you do not agree to these terms, please refrain from using our services.By accessing and using the services provided by Three13 I.T. Solutions, you agree to be bound by the following terms and conditions. All content, materials, and services on this platform are intended for educational and informational purposes only. Users are responsible for maintaining the confidentiality of their account credentials and for all activities that occur under their account. Unauthorized use, duplication, or distribution of course materials or proprietary content is strictly prohibited. Three13 I.T. Solutions reserves the right to update, modify, or terminate its services at any time without prior notice. By continuing to use our platform, you accept any changes to these terms. If you do not agree to these terms, please refrain from using our services.
          </Typography>

          {/* Add other terms sections here */}
