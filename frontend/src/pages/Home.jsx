          ...
          <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 1 }}>
            <Grid container spacing={{ xs: 5, md: 8 }} alignItems="center">
              ...
              <Grid item xs={12} md={5} sx={{ display: 'flex', justifyContent: { xs: 'center', md: 'flex-end' }, width: '100%' }}>
                <Box sx={{ bgcolor: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', borderRadius: 3, p: { xs: 2, md: 2.5 }, backdropFilter: 'blur(18px)', width: { xs: '100%', sm: 'min(78vw, 620px)', md: '100%' }, maxWidth: { xs: 620, md: 440 }, mx: { xs: 'auto', md: 0 } }}>
